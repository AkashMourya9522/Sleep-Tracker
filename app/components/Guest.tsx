    ...
    <div className='font-sans bg-gray-100 text-gray-800'>
      <div className='flex flex-col md:flex-row items-center justify-between p-3 md:p-16 bg-gray-100 pt-20'>
        <div className='flex-1 mb-8 xl:pl-10'>
          ...
          <SignInButton>
            <button className='w-full md:w-auto bg-gradient-to-r from-blue-500 to-purple-500  text-white px-4 py-2 rounded-md font-medium cursor-pointer'>
              Get Started
            </button>
          </SignInButton>
        </div>
      ...
      <div className='py-16 px-8 bg-gray-100'>
        ...
        <div className='max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
          <div className='bg-white p-6 rounded-lg shadow-md'>
            ...
            <p className='text-purple-500 font-bold'>- B.Raju</p>
          </div>
          <div className='bg-white p-6 rounded-lg shadow-md'>
            <p className='text-gray-700 mb-4'>
            ...
            <p className='text-purple-500 font-bold'>- K.Rakesh</p>
          </div>
          <div className='bg-white p-6 rounded-lg shadow-md'>
            <p className='text-gray-700 mb-4'>
